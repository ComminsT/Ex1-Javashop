				...
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<div class="row">
							...
							<img src="<%=produit.getImage() %>" class="img-responsive" alt="" style="width:270px; height:270px;"></div>
							<div class="col-md-7 col-sm-6">
								<div class="product-single">
									<div class="ps-header">
										...
										<div class="ps-price"><%=produit.getPrix() %>€</div>
									</div>
									<p>Nam placerat sem lacus, ut vestibulum enim pulvinar
										vitae. Sed sodales, tortor et auctor volutpat, nisl est
										sollicex, nec sollicitudin risus odio mollis ligula.
										Suspendisse eget augue purus. Proin a mauris ac arcu volutpat
										mattis ac eu odio. Fusce at porttitor orci, nec accumsan nunc.
										Quisque tempor massa turpis, a congue mauris fermentum in.
										Vivamus molestie ac elit nec semper. Aenean dolor ipsum,
										aliquam vitae mi iaculis, congue finibus magna.</p>
									<div class="ps-stock">
									...
									<div class="share">
										<span> <a href="#" class="fa fa-heart-o"></a> <a
											href="#" class="fa fa-signal"></a> <a href="#"
											class="fa fa-envelope-o"></a>
										</span>
						...
						<div role="tabpanel">
							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="home">
									...
									<div class="space10"></div>
									<p>Nam pellentesque tincidunt sem vehicula viverra. Mauris
										cursus nisl at ornare pharetra. In ullamcorper pellentesque
										justo quis porta. Nunc venenatis efficitur cursus. Ut id nisi
										hendrerit, lobortis ante ut, aliquam lacus. Praesent convallis
										eget arcu sit amet molestie. Phasellus ac ex ac metus
										hendrerit vestibulum in quis velit. Donec lacinia sit amet leo
										sit amet semper. Nunc molestie tincidunt odio vel
										pellentesque. Mauris maximus lorem quis lorem eleifend, ut
										mollis diam fermentum. Integer dapibus eros sed sagittis
										auctor. Duis at luctus diam. Ut non ullamcorper nibh.
										Suspendisse eget fringilla risus.</p>
									<div class="space20"></div>
									<ul class="dot">
										<li>100% cotton</li>
								...
								<div role="tabpanel" class="tab-pane" id="messages">
									...
									<form class="form-tags">
										<input type="text"><br> <span>Use spaces
											to separate tags. Use single quotes (') for phrases.</span><br>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12">
								...
								<%ArrayList<Produit> produits =(ArrayList)request.getAttribute("p");
                            	for(Produit ps : produits){ %>
									<div class="pc-wrap">
										<div class="product-item">
											<div class="item-thumb">
												<img src="<%=ps.getImage() %>" style="width:270px;height:270px;"
											...
											<div class="product-info">
												<h4 class="product-title">
													<a href="Detail?id=<%=ps.getId()%>"><%=ps.getTitre() %></a>
												</h4>
												<span class="product-price"><%=ps.getPrix()%>€ <em>- Pre
														order</em></span>
